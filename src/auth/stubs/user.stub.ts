export const userStub = () => {
  return {
    ...
    updatedAt: new Date(),
    hashedRT:
      '$argon2i$v=19$m=4096,t=3,p=1$RNg6IU+p1B3yC+8EgIps6Q$OqfSKYdoggrTS7i6XHk1GCT7lWsoBSu0RJykOWeFkZI',
    access_token:
    ...
    hashedPassword:
      '$argon2i$v=19$m=4096,t=3,p=1$sZvc3qoMohy8lLqUdBJLsg$6yjvUhIhl3VTKOldvWqmnLUkGLv6EY2YTx0RsTHm4Yc',
  };
};
